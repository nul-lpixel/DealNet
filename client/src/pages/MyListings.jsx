...
import { ArrowDownCircle, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, DollarSignIcon, Edit, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, StarIcon, TrashIcon, TrendingUp, Users, WalletIcon, XCircle } from 'lucide-react'
                          ...
                          <div className='invisible group-hover:visible absolute right-0 top-0 pt-4.5 z-10'>
                            <div className='bg-white text-gray-600 text-xs rounded border border-gray-200 p-2 px-3'>
                              {!listing.isCredentialSubmitted && (
                                <>
                                  <button onClick={()=>setShowCredentialSubmission(listing)} className=' flex items-center gap-2 text-nowrap'>Add Credential</button>
