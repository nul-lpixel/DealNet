    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-start max-md:flex-col gap-10'>
        <div className='flex-1 max-md:w-full '>
          ...
          {/* Screenshot Section */}
          {images?.length>0 && (
            <div className='bg-white rounded-xl border border-gray-500 mb-5 overflow-hidden'>
              <div className='p-4'>
          ...
          <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
              <div>
                <Users className='mx-auto mb-1 text-gray-400 w-5 h-5'/>
              ...
              <div>
                <LineChart className='mx-auto mb-1 text-gray-400 w-5 h-5'/>
                <p className='font-semibold text-gray-800'>
              ...
              <div>
                <Eye className='mx-auto mb-1 text-gray-400 w-5 h-5'/>
                <p className='font-semibold text-gray-800'>
              ...
              <div>
                <Calendar className='mx-auto mb-1 text-gray-400 w-5 h-5'/>
                <p className='font-semibold text-gray-800'>
        ...
        <div className='bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10'>
          ...
          <div className='flex items-center justify-between text-sm text-gray-600 mb-4'>
            <p>Members Since <span className='font-medium'>{new Date(listing.owner?.createdAt).toLocaleDateString()}</span></p>
          </div>

          <button onClick={loadChatbox} className='w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 
          transition text-sm font-medium flex items-center justify-center gap-2'>
            <MessageSquareMoreIcon className='size-4'/>Chat
          </button>

          {listing.isCredentialChanged && (
            <button onClick={purchaseAccount} className="w-full mt-2 bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 
            transition text-sm font-medium flex items-center justify-center gap-2">
      ...
      <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
          <p className='text-sm text-gray-500'>
            © 2026 <span className='text-indigo-600'> Tej</span>. All rights reserved.
          </p>
      </div>
