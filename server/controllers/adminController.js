...
export const getDashboard = async (req,res) => {
    try {
        ...
        const trasanctions = await prisma.transaction.findMany({
            where: {isPaid: true},
            select: {amount: true},
        })

        const totalRevenue = trasanctions.reduce((total, transaction) => total + transaction.amount, 0);    
...
export const markCredentialAVerified = async (req,res) => {
    try {
...
//chsnge credential for verified listing
...
export const getAllTransactions = async (req,res) => {
    try {
        ...
        //get customer details foreach trasanction and add it ti the trasanction object
